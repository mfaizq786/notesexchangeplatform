...
<body>
    ...
    <nav id="navbar" class="navbar navbar-expand-lg fixed-top navbar-dark" aria-label="Main navigation">
        <div class="container">
            ...
            <a class="navbar-brand logo-text" href="ServiceProviderindex.jsp">E-Notes</a>
            ...
            <div class="navbar-collapse offcanvas-collapse" id="navbarsExampleDefault" >
                <ul class="navbar-nav ms-auto navbar-nav-scroll">
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="ServiceProviderindex.jsp/#header">Home</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="ServiceProviderindex.jsp/#about">About</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="ServiceProviderindex.jsp/#services">Services</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="ServiceProviderindex.jsp/#plans">Plans</a>
                    </li>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="ServiceProviderindex.jsp/#contact">Feedback</a>
                    </li>
                </ul>
            ...
            <div class="row">
                ...
                <div class="col-lg-3 py-4 py-md-5">
                    <div>
                        ...
                        <div class="d-flex align-items-center py-2">
                            ...
                            <a href="ServiceProviderindex.jsp/#about"><p class="ms-3">About</p></a>
                            
                        </div>
                        <div class="d-flex align-items-center py-2">
                            <i class="fas fa-caret-right"></i>
                            <a href="ServiceProviderindex.jsp/#services"><p class="ms-3">Services</p></a>
                        </div>
                        <div class="d-flex align-items-center py-2">
                            <i class="fas fa-caret-right"></i>
                            <a href="ServiceProviderindex.jsp/#plans"><p class="ms-3">Plans</p></a>
                        </div>
                        <div class="d-flex align-items-center py-2">
                            <i class="fas fa-caret-right"></i>
                            <a href="ServiceProviderindex.jsp/#contact"><p class="ms-3">Contact</p></a>
                        </div>
                    </div>
                </div> <!-- end of col -->
                ...
                <div class="col-lg-3 py-4 py-md-5">
                    <div>
                        ...
                        <div class="d-flex align-items-center py-2">
                            <i class="fas fa-caret-right"></i>
                            <a href="ServiceProviderPrivacy.jsp"><p class="ms-3">Privacy</p></a>
                            
                        </div>
                        <div class="d-flex align-items-center py-2">
                            <i class="fas fa-caret-right"></i>
                            <a href="ServiceProviderterms.jsp"><p class="ms-3">Terms</p></a>
                        </div>
                        <div class="d-flex align-items-center py-2">
                            <i class="fas fa-caret-right"></i>
