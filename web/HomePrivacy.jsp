...
<body>
    ...
    <nav id="navbar" class="navbar navbar-expand-lg fixed-top navbar-dark" aria-label="Main navigation">
        <div class="container">
            ...
            <a class="navbar-brand logo-text" href="Adminindex.jsp">Mirko</a>
            ...
            <div class="navbar-collapse offcanvas-collapse" id="navbarsExampleDefault" >
                <ul class="navbar-nav ms-auto navbar-nav-scroll">
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="Homeindex.jsp#header">Home</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="Homeindex.jsp#about">About</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="Homeindex.jsp#services">Services</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="Homeindex.jsp#plans">Plans</a>
                    </li>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="Homeindex.jsp#contact">Contact</a>
                    </li>
                </ul>
        ...
        <div class="container">
            <div class="row">
                <div class="col-xl-10 offset-xl-1">
                    ...
                    <a class="btn btn-tertiary" href="Homeindex.jsp#contact">Contact Us</a>
                ...
                <div class="col-lg-3 py-4 py-md-5">
                    <div>
                        ...
                        <div class="d-flex align-items-center py-2">
                            ...
                            <a href="Homeindex.jsp#about"><p class="ms-3">About</p></a>
                        </div>
                        <div class="d-flex align-items-center py-2">
                            <i class="fas fa-caret-right"></i>
                            <a href="Homeindex.jsp#services"><p class="ms-3">Services</p></a>
                        </div>
                        <div class="d-flex align-items-center py-2">
                            <i class="fas fa-caret-right"></i>
                            <a href="Homeindex.jsp#plans"><p class="ms-3">Plans</p></a>
                        </div>
                        <div class="d-flex align-items-center py-2">
                            <i class="fas fa-caret-right"></i>
                            <a href="Homeindex.jsp#contact"><p class="ms-3">Contact</p></a>
                        </div>
                    </div>
                </div> <!-- end of col -->
