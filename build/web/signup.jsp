        ...
        <div class="container">
            ...
            <div class="navbar-collapse offcanvas-collapse" id="navbarsExampleDefault" >
                <ul class="navbar-nav ms-auto navbar-nav-scroll">
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="index.jsp#header">Home</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="index.jsp#plans">Plans</a>
                    </li>
                     <li class="nav-item">
        ...
        <div class="container">
            <div class="row" >
                <div class="col-xl-10 offset-xl-1" >
                     ...
                     <form  action="#" method="post" style="height:700px; width:400; margin: 0px auto;">
                        ...
                        <input type="text" id="username" name="name" required> <br>
                         ...
                         <select id="username" name="utype" style="background:#1c262f; color:white;">
                            <option>Select login Type </option>
                            <option value="buyer">User </option>
                            <option value="uploader">Service Provider </option>
                            
                        </select>
                        
                         <label for="contact">Contact</label>
                        <input type="text" id="username" name="cont" required>
                        ...
                        <button class="m-5" type="submit" name="opr1">Add</button>
                    ...
                    <%
                        try{
                            if(request.getParameter("opr1")!= null){
                                if(request.getParameter("utype").equals("buyer")){
                                String email = request.getParameter("email");
                                String name = request.getParameter("name");
                                String cont = request.getParameter("cont");
                                String pass = request.getParameter("pass");
                                String cpass = request.getParameter("cpass");
//                                out.println("<script>alert('i am clicked') </script>");
                                out.println("<script>alert(email) </script>");
                                if(pass.equals(cpass)){

                                    DB.DBConnection db = new DB.DBConnection();
                                    db.pstmt = db.con.prepareStatement("insert into login(name,email,cont,pass,status,ltype) values(?,?,?,?,'1','buyer')");
                                   ...
                                   out.println("<script>Password and Confirm Password Does Not Matched</script>");  
                                }
                            }
                            else if(request.getParameter("utype").equals("uploader")){
                                ...
                                if(pass.equals(cpass)){
                                    ...
                                    DB.DBConnection db = new DB.DBConnection();
                                    db.pstmt = db.con.prepareStatement("insert into login(name,email,cont,pass,status,ltype) values(?,?,?,?,'1','uploader')");
                                    db.pstmt.setString(1,name); 
                                    db.pstmt.setString(2,email);
                                    db.pstmt.setString(3,cont);
                                    db.pstmt.setString(4,pass);
    ...
    //                           else if(request.getParameter("utype").equals("uploader")){
    //                                out.println("<script>alert('Purchase plans!!!');</script>");
    //                            }
                                }
                        }
                        catch(Exception e){
            ...
            <div class="row">
                ...
                <div class="col-lg-3 py-4 py-md-5">
                    <div>
                        ...
                        <div class="d-flex align-items-center py-2">
                            ...
                            <a href="Adminindex.jsp#about"><p class="ms-3">About</p></a>
                            
                        </div>
                        <div class="d-flex align-items-center py-2">
                            <i class="fas fa-caret-right"></i>
                            <a href="Adminindex.jsp#services"><p class="ms-3">Services</p></a>
                        </div>
                        <div class="d-flex align-items-center py-2">
                            <i class="fas fa-caret-right"></i>
                            <a href="Adminindex.jsp#plans"><p class="ms-3">Plans</p></a>
                        </div>
                        <div class="d-flex align-items-center py-2">
                            <i class="fas fa-caret-right"></i>
                            <a href="Adminindex.jsp#contact"><p class="ms-3">Contact</p></a>
                        </div>
                    </div>
                </div> <!-- end of col -->
                ...
                <div class="col-lg-3 py-4 py-md-5">
                    <div>
                        ...
                        <div class="d-flex align-items-center py-2">
                            <i class="fas fa-caret-right"></i>
                            <a href="AdminPrivacy.jsp"><p class="ms-3">Privacy</p></a>
                            
                        </div>
                        <div class="d-flex align-items-center py-2">
                            <i class="fas fa-caret-right"></i>
                            <a href="Adminterms.jsp"><p class="ms-3">Terms</p></a>
                        </div>
                        <div class="d-flex align-items-center py-2">
                            <i class="fas fa-caret-right"></i>
