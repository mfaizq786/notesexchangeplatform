...
<body><br><br>
<center><h1>Purchase Here</h1></center> <button  style="background: red;margin-left: 10%; height: 40px;width: 100px;"><a href="UserData.jsp" style="text-decoration: none;color:white; ">Back</a></button>
<div class="container">
    <div class="row">
                            ...
                            <div class="col-lg-7">
                                <form action="" class="form">
                                    <div class="row">
                                        ...
                                        <div class="col-12">
                                            <button  style='background:blue; padding: 10px 20px; border-radius: 5px;' ><a style=' color:white; text-decoration:none' href='assets/pdf<%=aaa%>'>Submit</a></button>
