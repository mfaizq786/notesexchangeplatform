...
<h3 style="margin-top:0px; color: white;text-align: center;">Blocked Buyer List</h3>
<button style="margin-left: 1000px;background: red;height:50px;width: 100px; border-radius: 5px; "><a style="text-decoration: none; color:white; "
          href="AdminBuyerList.jsp">Back</a></button>
                   ...
                   <th>Delete</th>
                    ...
                    <%
                      try{
                          ...
                          db.pstmt = db.con.prepareStatement("select * from login where ltype='buyer' and status='3' ");
                          ...
                          while(db.rst.next()){
                            out.println("<tr><td>"+count+"</td><td>"+db.rst.getString(1)+"</td>"
                                    ...
                                    + "<td>"+db.rst.getString(7)+"</td><td>"
                                     + "<button style='width:80px;background:green; '><a  style=' color:white;text-decoration:none;' href=AdminUnBlockBuyer.jsp?id="+db.rst.getString(1)+">UnBlock</a> </button></td>"
                                    + "<td><button style='width:80px;background:blue;color:red;'><a  style=' text-decoration:none;' href=AdmindeleteNotes.jsp?uploaderid="+db.rst.getString(1)+">Delete</a> </button></td></tr>");
                            count++;
                          }
