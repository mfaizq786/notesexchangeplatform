...
<body>
    ...
    <nav id="navbar" class="navbar navbar-expand-lg fixed-top navbar-dark" aria-label="Main navigation">
        <div class="container">
            ...
            <a class="navbar-brand logo-text" href="Homeindex.jsp">E Notes</a>
            ...
            <div class="navbar-collapse offcanvas-collapse" id="navbarsExampleDefault" >
                <ul class="navbar-nav ms-auto navbar-nav-scroll">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" onclick="demo()" >Notes</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="dropdown01">
                            <li><a class="dropdown-item" href="article.html">Service Provider Login</a></li>
                            <li><div class="dropdown-divider"></div></li>
                            <li><a class="dropdown-item" href="terms.html">User Login</a></li>
                            <li><div class="dropdown-divider"></div></li>
                            <li><a class="dropdown-item" href="privacy.html">Sign-up</a></li>
                        </ul>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" onclick="demo()" >Contact</a>
                    </li>
                </ul>
    ...
    <section class="home py-5 d-flex align-items-center" id="header">
        <div class="container text-light py-5"  data-aos="fade-right"> 
            ...
            <p class="para para-light py-3">We provide a notes for anyone who intrested in this. our material which is absolutly correct and efficient for everyone. We provide the best content of the topic which is easy to understand for everyone.</p>
        ...
        <div class="container" >
            <div class="row d-flex align-items-center">
                <div class="col-lg-7" data-aos="fade-right">
                    ...
                    <p class="py-2 para-light">We provide a notes for anyone who intrested in this. our material which is absolutly correct and efficient for everyone. We provide the best content of the topic which is easy to understand for everyone.</p>
                    <p class="py-2 para-light">There are two category of the notes in our site which is basically in two types our forst type is free and the second type is paid.</p>
    ...
    <section class="services d-flex align-items-center py-5" id="services">
        <div class="container text-light">
            <div class="text-center pb-4" >
                ...
                <p class="para-light">We provide the notes in some diffrent type which is shown below</p>
            </div>
            <div class="row gy-4 py-2" data-aos="zoom-in">
                <div class="col-lg-4">
                    <div class="card bg-transparent">
                        <i class="fas fa-solid fa-file-pdf fa-2x"></i>
                        <h4 class="py-2" onclick="demo()">PDF FROMAT</h4>
                ...
                <div class="col-lg-4">
                    <div class="card bg-transparent">
                        ...
                        <h4 class="py-2" onclick="demo()">TEXT FORMAT</h4>
                ...
                <div class="col-lg-4">
                    <div class="card bg-transparent">
                        ...
                        <h4 class="py-2" onclick="demo()">HAND WRITTEN</h4>
            ...
            <div class="row gy-4" data-aos="zoom-in">
                <div class="col-lg-4">
                    <div class="card bg-transparent px-4">
                        ...
                        <div class="my-3">
                            <a class="btn" onclick="demo()" >View Plans</a>
                        </div>
                    </div>  
                </div>
