...
<body>
<button style="background: red;"><a href="ServiceProviderindex.jsp"style="color:white;text-decoration: none;">Back</a></button>
   <br>
   <div class="cards-container">
   <%
//        int id1 =Integer.parseInt(request.getParameter("id"));
          int id1 = Integer.parseInt(""+session.getAttribute("id"));  //upadated 
     ...
     String course = request.getParameter("course");
        ...
        db1.pstmt  = db1.con.prepareStatement("select * from notes where  course=? and uploaderid=?");
        db1.pstmt.setString(1, course);
        db1.pstmt.setInt(2, id1);
  ...
  <div class="card">
        ...
        <div class="price-view-buy">
            <div>Price: <%=db1.rst.getString(4)  %></div>
