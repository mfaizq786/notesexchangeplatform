            ...
            <div class="row">
                <div class="col-lg-6 d-flex justify-content-center justify-content-lg-end align-items-center px-lg-5" data-aos="fade-right">
                    ...
                    <div style="">
                        ...
                        <div class="my-3">
                            <input type="submit" class="btn form-control-submit-button" style="width: 100px; " name="opr1" value="Submit">
                        </div>
                        </form>
                    </div> <!-- end of div -->
                </div> <!-- end of col -->
                    ...
                    <%
                         try{
                                      if(request.getParameter("opr1")!= null){
                                          ...
                                          db.pstmt = db.con.prepareStatement("insert into feedback values('1','Admin',?,?,?,?,curdate())");
