...
<head>
    ...
    <!-- Webpage Title -->
    <title>Notes Exchange Platform</title>
        ...
        <div class="container">
            ...
            <div class="navbar-collapse offcanvas-collapse" id="navbarsExampleDefault" >
                <ul class="navbar-nav ms-auto navbar-nav-scroll">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#services" >Notes</a>
                    </li>
                    <li class="nav-item">
        ...
        <div class="container-fluid">  
            <div class="row text-light">
                <div class="col-lg-4 text-center p-5" data-aos="zoom-in">
                    ...
                    <p class="para-light">You can download the notes </p>
                </div>
                <div class="col-lg-4 text-center p-5"  data-aos="zoom-in">
    ...
    <section class="services d-flex align-items-center py-5" id="services">
        <div class="container text-light">
            ...
            <div class="row gy-4 py-2" data-aos="zoom-in">
                <div class="col-lg-4" onclick="window.alert('Please Log in to open Notes Section')">
                    <div class="card bg-transparent">
                        <i class="fas fa-solid fa-file-pdf fa-2x"></i>
                        <h4 class="py-2" onclick="window.alert('Please Log in to open Notes Section')" >PDF FROMAT</h4>
            ...
            <div class="row">
                <div class="col-lg-6 d-flex justify-content-center justify-content-lg-end align-items-center px-lg-5" data-aos="fade-right">
                    <div style="width:90%">
                        ...
                        <div class="my-3">
                            <a class="btn form-control-submit-button" onclick="demo()">Submit</a>
                        </div>
                    </div> <!-- end of div -->
                </div> <!-- end of col -->
